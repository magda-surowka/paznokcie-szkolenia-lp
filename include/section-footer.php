        ...
        <div class="footer-wrapper">
            ...
            <div class="footer-form">
                <form method="post" action="">
                    ...
                    <div class="row">
                        <div class="form-element col-lg-6">
                            ...
                            <div class="input-wrapper">
                                <input type="text" name="input_name" required="required" value="">
                            </div>
                        </div>
                        <div class="form-element col-lg-6">
                            <label>Nazwisko *</label>
                            <div class="input-wrapper">
                                <input type="text" name="input_surname" required="required" value="">
                            </div>
                        </div>
                        <div class="form-element col-lg-6">
                            <label>Adres e-mail *</label>
                            <div class="input-wrapper">
                                <input type="text" name="input_email" required="required" value="">
                            </div>
                        </div>
                        <div class="form-element col-lg-6">
                        ...
                        <div class="form-element col-lg-12">
                            ...
                            <div class="input-wrapper">
                                <textarea rows="6" name="input_content"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="info">
                    ...
                    <div class="formal" id="terms">
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit, recusandae, totam alias aperiam
                            quasi modi inventore, quam voluptates nostrum consequatur ex ipsum fugit perspiciatis
                            reiciendis?</p>
                    </div>
